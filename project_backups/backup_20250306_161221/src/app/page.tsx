      ...
      <section className="relative flex flex-col items-center justify-center px-4 py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          <h1 className="mb-6 text-5xl font-bold tracking-tight md:text-7xl">
            <span className="text-blue-400">LINK BOT</span> TRADING BUSINESS
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button 
              className="px-8 py-4 text-lg font-medium transition-all bg-purple-600 rounded-md hover:bg-purple-700"
              asChild
            >
